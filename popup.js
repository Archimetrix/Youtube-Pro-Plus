...
document.addEventListener('DOMContentLoaded', () => {
    ...
    toggles.forEach(toggle => {
        document.getElementById(`toggle-${toggle}`).addEventListener('change', (e) => {
            ...
            if (['premium', 'ambient', 'cinematic', 'download', 'autoResume', 'screenshot', 'watchparty', 'miniplayer', 'pipmode', 'returnDislike', 'sponsorblock'].includes(toggle)) {
                chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
    ...
    const tipContent = {
        ...
        download: {
            ...
            body:  'Replaces YouTube\'s normal Download action with a Smart Download flow that opens the configured third-party downloader and automatically submits the video URL. If you are a YouTube Premium subscriber, keep Smart Download turned OFF.'
        },
        screenshot: {
